  ...
  return (
    <nav className={`fixed left-0 right-0 top-0 z-50 transition-all duration-300 ${
              ...
              {navigation.map((item) => (
                ...
                >
                  <span className={`relative z-10 transition-colors duration-300
                    ${scrolled ? 'text-primary-950 dark:text-primary-50' : 'text-primary-950 dark:text-primary-50'}
      ...
      <div
        ...
        } fixed bottom-0 left-0 top-20 w-full overflow-y-auto bg-gradient-to-b from-primary-900/95 to-primary-950/95 backdrop-blur-md transition-all duration-300 ease-in-out md:hidden`}
      >
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex flex-col items-center space-y-4">
            {navigation.map((item) => (
              ...
              >
                <div className="relative overflow-hidden rounded-xl bg-primary-800/30 p-4 backdrop-blur-sm">
                  <div className="absolute inset-0 bg-gradient-to-r from-primary-600/10 to-accent-500/10 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                  <div className="relative z-10 flex items-center justify-between">
                    <span className="text-lg font-medium text-primary-50">{item.name}</span>
                    <svg 
          ...
          <div className="mt-8 flex justify-center">
            <a 
              href="/contact"
              onClick={() => setIsOpen(false)}
              className="group relative overflow-hidden rounded-full bg-accent-500 px-8 py-3 text-center text-lg font-semibold text-primary-950 shadow-lg transition-all duration-300 hover:scale-105 hover:bg-accent-400 hover:shadow-accent-500/25"
            >
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="h-full w-full animate-pulse-slow rounded-full bg-accent-400/50 opacity-0 group-hover:opacity-100" />
              </div>
          ...
          <div className="mt-12 flex justify-center space-x-6">
            <a href="#" className="transform text-primary-200 transition-all duration-300 hover:scale-125 hover:text-accent-300">
